      ...
      <div className="hero-content flex-col ">
        ...
        <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl  bg-slate-200">
          <div className="card-body">
            <form onSubmit={handleRegister}>
              <div className="form-control">
                <label className="label">
                  <span className="label-text">
                    Name<sup className="text-blue-800">*</sup>
                  </span>
                </label>
                <input
                  type="name"
                  name="name"
                  placeholder="name"
                  className="border-blue-800 input input-bordered"
                  required
                />
              </div>
              <div className="form-control">
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text">
                    Email<sup className="text-blue-800">*</sup>
                  </span>
                </label>
                <input
                  type="email"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text">
                    Password<sup className="text-blue-800">*</sup>
                  </span>
                </label>
                <input
                  ...
                  className="border-blue-800 input input-bordered relative"
                  required
                />
          ...
          <p className="p-3 text-center">
            ...
            <Link to="/login">
              <button className="btn btn-link text-blue-800">login</button>
            </Link>
          </p>
        </div>
      </div>
